...
ws=wb.active
#path
excelname = 'C:/Users/15920/Desktop/jicheng/data/DataExcel/R4S.xlsx'
wb.save(excelname)
# read txt
col = 1
def get_file_name_1(file_path):
    ...
    return file_names
file_path = 'C:/Users/15920/Desktop/jicheng/data/R4S'
...
xl=openpyxl.load_workbook('C:/Users/15920/Desktop/jicheng/data/DataExcel/R4S.xlsx')
